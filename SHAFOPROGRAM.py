...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open  https://instagram.com/sha_fo_ka?igshid=c1neeniq6wit')
    else:
...
def pilih_super():
	...
	p.map(main, id)
	print 42*"\033[1;96m="
	print '\033[1;96m[\033[1;97m✓\033[1;96m] \033[1;92mProcess Has Been Completed SHAFO hewadarm sude habe supas♥️ \033[1;97m....'
